...
$(function () {
    var team = new Team();
    var teamGrid=GridInitializer.InitGrid(
        [
            'Id',
            'Creation date',
            'Title',
    ...
    teamGrid.navButtonAdd('#pager', { caption: "Edit", onClickButton: function () { new Entity(team).GetCurrent(false, saveJsonModel); }, position: "first", title: "", id: "editGridButton" });
