...
var TablesRenderer = function (role) {
    ...
    var renderEstimateTable = function () {
        var estimates = { grid: $("#estimates"), getdataurl: "location/getestimates?team=" + $('#team').val() + "&customer=" + $("#Id").val() };
    ...
    var renderRepairOrderTable = function () {
        var repairOrders = { grid: $("#repairOrders"), getdataurl: "location/getrepairorders?team=" + $('#team').val() + "&customer=" + $("#Id").val() };
    ...
    var renderInvoiceTable = function () {
        var invoices = { grid: $("#invoices"), getdataurl: "location/getinvoices?team=" + $('#team').val() + "&customer=" + $("#Id").val() };
    ...
    this.Render = function () {
        ...
        $('#team').change(function () {
            $("#estimates").setGridParam({
                url: "location/getestimates?customer=" + $("#Id").val() + "&team=" + $(this).val()
            }).trigger("reloadGrid");

            $("#repairOrders").setGridParam({
                url: "location/getrepairorders?customer=" + $("#Id").val() + "&team=" + $(this).val()
            }).trigger("reloadGrid");

            $("#invoices").setGridParam({
                url: "location/getinvoices?customer=" + $("#Id").val() + "&team=" + $(this).val()
            }).trigger("reloadGrid");
