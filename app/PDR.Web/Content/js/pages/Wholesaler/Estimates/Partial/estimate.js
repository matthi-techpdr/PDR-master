...
//    estimateViewModel.wholesale.dataBindChange();
//    debugger;
//    estimateViewModel.wholesale.parent.updateData();
...
//    estimateViewModel.wholesale.dataBindChange();
//    estimateViewModel.wholesale.parent.updateData();
//    estimateViewModel.wholesale.matrixId.selectBox('value', window.globals.currentMatrix);
...
function CustomerWholesaleInfo(parent) {
    var self = this;
    self.parent = parent;
    self.insurance = window.globals.currentCustomer.Insurance;
    //    self.wholesaleId = $('#Customer_Wholesale_CustomerId');
    //    self.wholesalaMatrixId = $('#Customer_Wholesale_MatrixId');
        self.matrixId = $('#Customer_MatrixId');
 //   self.wholesalaMatrixId = $('#Customer_MatrixId');
    ...
    //    };
    self.dataBindChange = function () {
//        self.parent.selectBox.selectBox('enable');
//        var a = self.matrixId.length;
//        self.wholesaleId.bind('change', function () { self.parent.updateMatrixData(); });
        self.matrixId.bind('change', function() {
