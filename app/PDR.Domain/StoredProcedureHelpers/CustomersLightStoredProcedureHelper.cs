...
{
    public class CustomersLightStoredProcedureHelper : IStoredProcedureHelper
    {
        private readonly ISession session;

        private IList<string> Parameters { get; set; }

        private const string SP = "exec [dbo].[GetCustomerLigthModels] ";
        ...
        public CustomersLightStoredProcedureHelper(long userId, string customerType, long? filterByTeam = null, long? filterByStates = null, bool? isOnlyOwn = null, int? rowsPerPage = null,
